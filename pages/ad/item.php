                            ...
                            <div class="x_content">
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#AddItemModal">Add Item</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="AddItemModal" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label>DP <span class="red">(*)</span></label>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-dark" name="btnadditem" id="btnadditem">Save</button>
                                    <button class="btn btn-dark" data-dismiss="modal">Cancel</button>
                                </div>
                            </div>
                        </div>
        ...
        $('#AddItem').bootstrapValidator({
            ...
            fields: {
                ...
                ItemColor: {
                    validators: {
                        notEmpty: {
                            message: 'Please select color. Required!'
                        }
                    }
                },
                Category: {
