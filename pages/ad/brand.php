                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            foreach ($BrandQuery as $vBrand) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= @$Brand ?></td>
                                                    <td>
                                                        <button class="btn btn-dark" data-target='#EditBrandModal<?= @$BrandID; ?>' data-toggle='modal'><i class="fa fa-eye"></i></button>
                                                        <button class="btn btn-danger" data-toggle="modal" data-target="#DeleteBrandModal<?= @$BrandID; ?>"><i class="fa fa-trash"></i></button>
                                                    </td>
                                                </tr>

                                                <!-- Delete Brand Modal -->
                                                <div class="modal fade" id="DeleteBrandModal<?= @$BrandID; ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="function/admin-delete.php" method="POST" name="DeleteBrand" id="DeleteBrand">
                                                                ...
                                                                <div class="modal-body">
                                                                    <label>Do you want to delete this Brand "<?= @$Brand; ?>"</label>
                                                ...
                                                <!-- Edit Brand Modal -->
                                                <div class="modal fade" id="EditBrandModal<?= @$BrandID; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="function/functions.php" method="POST" name="UpdateBrand" id="UpdateBrand" autocomplete="off">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" style="text-transform: uppercase" id="EditBrandCode" name="EditBrandCode" value="<?= @$BrandCode; ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Brand <span class="red">(*)</span></label>
                                                                        <input type="text" class="form-control" style="text-transform: uppercase" id="EditBrand" name="EditBrand" value="<?= @$Brand; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button class="btn btn-dark" id="btnupdatebrand" name="btnupdatebrand">Update</button>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        if ($num > 0) {
                                            ...
                                            echo '<input type="hidden" readonly class="form-control" value="' . $IdFormat . '' . $start . '" name="BrandID" id="BrandID">';
                                        } else {
                                            echo '<input type="hidden" readonly class="form-control" value="' . $IdFormat . '' . $start . '" name="BrandID" id="BrandID">';
                                        }
                                        ?>
