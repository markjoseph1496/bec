                            ...
                            <div class="x_content">
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Pending Purchase Requests</a></li>
                                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Purchase Request History</a></li>
                                        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Rejected / Cancelled Requests</a></li>
                                    </ul>
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered">
                                                        ...
                                                        foreach ($purchaserequests as $purchase) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-dark" onclick="PODetails(this.value);" value="<?= @$PONumber ?>" data-toggle="modal" data-target="#PODetails"><i class="fa fa-eye"></i></button>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
